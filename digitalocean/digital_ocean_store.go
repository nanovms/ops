...
func (s *Spaces) getImageSpacesURL(config *lepton.Config, imageName string) string {
...
func (s *Spaces) CopyToBucket(config *lepton.Config, archPath string) error {
...
func (s *Spaces) DeleteFromBucket(config *lepton.Config, key string) error {
	bucket := config.CloudConfig.BucketName
...
func (s *Spaces) getMinioClient(config *lepton.Config) (*minio.Client, error) {
