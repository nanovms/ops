...
// StartImageCommandFlags consolidates all command flags required to start an image in one struct
...
// NewStartImageCommandFlags returns an instance of StartImageCommandFlags initialized with command flags values
func NewStartImageCommandFlags(cmdFlags *pflag.FlagSet) (flags *StartImageCommandFlags) {
	var err error
	flags = &StartImageCommandFlags{}
...
// PersistStartImageCommandFlags append a command the required flags to run an image
func PersistStartImageCommandFlags(cmdFlags *pflag.FlagSet) {
