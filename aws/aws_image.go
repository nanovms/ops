...
func getArchitecture(flavor string) string {
	...
	instanceFamily := strings.ToLower(strings.Split(flavor, ".")[0])

	if arc, isExist := Architectures[instanceFamily]; isExist {
		return arc
	}
	return "x86_64"
}
