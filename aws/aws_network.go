...
func (p *AWS) CheckValidSecurityGroup(ctx *lepton.Context, svc *ec2.EC2) error {
...
func (p *AWS) CreateSG(ctx *lepton.Context, svc *ec2.EC2, imgName string, vpcID string) (string, error) {
	t := time.Now().UnixNano()
